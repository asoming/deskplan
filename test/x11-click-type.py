...
import ctypes as c,ctypes.util,sys,time,os
...
t.XTestFakeMotionEvent(d,-1,round(int(sys.argv[1])*float(os.environ.get('RIXU_TEST_SCALE','1'))),round(int(sys.argv[2])*float(os.environ.get('RIXU_TEST_SCALE','1'))),0)
