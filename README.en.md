<p align="center"><img src="src/assets/icon-128.png" width="88" alt="DeskPlan icon"></p>
<h1 align="center">DeskPlan · 日序</h1>
<p align="center">Desktop task planning · Today, Week, priorities and deadlines</p>
<p align="center"><a href="README.md">简体中文</a> · <a href="https://github.com/asoming/deskplan/releases/latest">Download</a> · <a href="docs/INTRO.en.md">Introduction</a> · <a href="docs/RESEARCH.zh-CN.md">User research</a></p>

DeskPlan is a minimal, local-first desktop planner. Today, Week, four urgency zones and Inbox share the same tasks. Drop in files, plan your days, adjust transparency, and switch to a small panel that never stays on top when you want to focus.
...
![DeskPlan desktop blend mode](docs/images/english-planner.png)
...
- **Portable data:** full JSON backups and readable CSV export. Attachments are references to original files; backups do not include file contents and DeskPlan does not delete originals.

## Downloads

Get the matching asset from [GitHub Releases](https://github.com/asoming/deskplan/releases/latest).

| Platform | Asset |
| --- | --- |
| Debian / Ubuntu x64 | `DeskPlan-1.0.11-linux-x64.deb` |
| Other Linux x64 | `DeskPlan-1.0.11-linux-x64.tar.gz` |
| Windows x64 | `DeskPlan-1.0.11-windows-x64-setup.exe` |
| macOS Apple Silicon | `DeskPlan-1.0.11-mac-arm64.dmg` or `.zip` |
| macOS Intel | `DeskPlan-1.0.11-mac-x64.dmg` or `.zip` |

Use the Windows installer, drag the macOS app into Applications, or install the Debian package with your software manager / `sudo apt install ./DeskPlan-1.0.11-linux-x64.deb`.
...
Report problems in [Issues](https://github.com/asoming/deskplan/issues). Source is publicly viewable; no open-source license is currently granted. Copyright remains with the author. Third-party components retain their respective licenses.
