...
if(process.platform==='linux'){
 ...
 const entry=fs.readFileSync(path.join(dir,'usr/share/applications/io.rixu.desktop'),'utf8');assert.match(entry,/StartupWMClass=io.rixu/);assert.match(entry,/Icon=rixu/);
